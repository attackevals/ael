...
namespace Quasar.Server.Networking
{
    public class Server
    {
        ...
        /// <summary>
        /// Maps client ID string to Client connected to the server.
        /// </summary>
        protected readonly Dictionary<string, Client> _clientMap = new Dictionary<string, Client>();
        ...
        /// </summary>
        public Client LookupClientById(string clientId)
        {
            lock (_clientsLock)
            {
        ...
        private void RemoveClient(Client client)
        {
            ...
            lock (_clientsLock)
            {
                ...
                _clientMap.Remove(client.ClientId);
            }
        }
