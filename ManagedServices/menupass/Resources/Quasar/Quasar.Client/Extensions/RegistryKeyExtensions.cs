...
namespace Quasar.Client.Extensions
{
    ...
    public static class RegistryKeyExtensions
    {
        ...
        public static string GetValueSafe(this RegistryKey key, string keyName, string defaultValue = "")
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions GetValueSafe exception: {0}", ex.ToString()));
                return defaultValue;
            }
        }
        ...
        public static RegistryKey OpenReadonlySubKeySafe(this RegistryKey key, string name)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions OpenReadonlySubKeySafe exception: {0}", ex.ToString()));
                return null;
            }
        }
        ...
        public static RegistryKey OpenWritableSubKeySafe(this RegistryKey key, string name)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions OpenWritableSubKeySafe exception: {0}", ex.ToString()));
                return null;
            }
        }
        ...
        public static RegistryKey CreateSubKeySafe(this RegistryKey key, string name)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions CreateSubKeySafe exception: {0}", ex.ToString()));
                return null;
            }
        }
        ...
        public static bool DeleteSubKeyTreeSafe(this RegistryKey key, string name)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions DeleteSubKeyTreeSafe exception: {0}", ex.ToString()));
                return false;
            }
        }
        ...
        */
        ...
        public static bool RenameSubKeySafe(this RegistryKey key, string oldName, string newName)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions RenameSubKeySafe exception: {0}", ex.ToString()));
        ...
        public static bool SetValueSafe(this RegistryKey key, string name, object data, RegistryValueKind kind)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions SetValueSafe exception: {0}", ex.ToString()));
                return false;
            }
        }
        ...
        public static bool DeleteValueSafe(this RegistryKey key, string name)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions DeleteValueSafe exception: {0}", ex.ToString()));
                return false;
            }
        }
        ...
        public static bool RenameValueSafe(this RegistryKey key, string oldName, string newName)
        {
            ...
            {
                Logger.Error(String.Format("RegistryKeyExtensions RenameValueSafe exception: {0}", ex.ToString()));
