...
variable "associate_public_ip" {
  type        = bool
  description = "[Defaults to False] Allows public IP to be associated with instance at creation. You SHOULD NOT DO THIS unless you have a good reason."
  default     = false
}
...
variable "iam_instance_profile" {
  type        = string
  description = "IAM instance profile to associate with the instance, defaults to null"
  default     = null
}
...
############################################################################
### Extra fields for Instance Create (Not Used Right now)
############################################################################

# variable "market_type" {
#   type        = null
#   description = "Type of market for the instance. Valid value is spot. Defaults to spot."
# }
