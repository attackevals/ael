...
* [Step 0 - Start C2 Server](/Enterprise/carbanak/Emulation_Plan/Scenario_1#step-0---start-c2-server)
* [Step 1 - Initial Access](#step-1---initial-breach)
* [Step 2 - Local Discovery and Collection](#step-2---target-assessment)
* [Step 3 - 2<sup>nd</sup> Stage RAT](#step-3---deploy-toolkit)
* [Step 4 - Domain Discovery and Credential Dumping](#step-4---escalate-privileges)
* [Step 5 - Lateral Movement](#step-5---expand-access)
* [Step 6 - Discovery](#step-6---discover-potential-targets)
* [Step 7 - Lateral Movement - CFO](#step-7---setup-persistence)
* [Step 8 - Execution](#step-8---gain-covert-access-to-target)
* [Step 9 - Collection](#step-9---profile-a-victim-user)
* [Step 10 - VNC Persistence](#step-10---impersonate-victim)
