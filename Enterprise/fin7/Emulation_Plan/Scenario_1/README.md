...
Prior to beginning the following emulation Scenario, ensure you have the proper infrastructure requirements and configuration in place as stated in the [Scenario 1 Infrastructure](/Enterprise/fin7/Emulation_Plan/Scenario_1/Infrastructure.md) documentation.
...
`Adb156.exe` then loads `scrobj.dll` and executes [`sql-rat.js`](/Enterprise/fin7/Resources/Step1/sql-rat.js) via jscript ([T1059.7](https://attack.mitre.org/techniques/T1059/007/)).
...
1. Upload the [PowerShell stager](/Enterprise/fin7/Resources/Step2/stager.ps1) via SQLRat.
