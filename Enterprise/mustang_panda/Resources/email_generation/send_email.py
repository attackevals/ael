...
def build_email_message(sender, sender_name, recipients, cc_list, subject, body, logo, attachment):
...
def main():
    ...
    parser.add_argument('-cc', dest='cc_list', help='Comma-separated email addresses to add to CC list', default='')
