...
```shell
usage: send_email.py [-h] -t RECIPIENTS_STR [-cc CC_LIST] [-f SENDER] [-fn SENDER_NAME] [-s SUBJECT] [-l LOGO] [-a ATTACHMENT_PATH] [-an ATTACHMENT_NAME] smtp_server html_path
...
options:
  ...
  -cc CC_LIST           Comma-separated email addreses to add to CC list
