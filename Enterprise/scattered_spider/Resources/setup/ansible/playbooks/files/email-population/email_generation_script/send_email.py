...
# Copyright 2024 MITRE. Approved for public release. Document number CT0006.
...
def main():
    ...
    parser.add_argument(
        ...
        required=True,
        dest="recipients_str",
        help="Comma-separated email addresses to send the email to",
    )
    ...
    mime_message = build_email_message(
        args.sender,
        args.sender_name,
        args.recipients_str,
        args.subject,
